define(['core', 'tpl', 'biz/goods/picker', 'biz/plugin/diyform'], function(core, tpl, picker, diyform) {
    ...
    modal.init = function() {
        var type = $("#types").val();
        $('.ts_a').css('color','#F87622');
        $('.ts_b').css('color','#333');
        core.json('member/cart/get_list', {type:type}, function(ret) {
    ...
    modal.bindEvents = function() {
        ...
        $('.tabTops-a').unbind('click').click(function() {
            // var type = $("#types").val();
        ...
        $('.btn-submit').unbind('click').click(function() {
            ...
            core.json('member/cart/submit', {type:type}, function(ret) {
                console.log(ret);
                if (ret.status != 1) {
