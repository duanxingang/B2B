define(['core', 'tpl', 'biz/goods/picker','biz/goods/wholesalePicker'], function (core, tpl, picker,wholesalePicker) {
    ...
    modal.init = function (params) {
        ...
        //点击搜索
        $('.searches').unbind('click').click(function() {
            $('.container').empty();
            modal.params = defaults;
            modal.page = 1;
            modal.params.keywords = $('#search').val();
    ...
    modal.searchTime = function(){
        //焦点
        $("#search").focus(function(){
            setInterval(function(){
                var keywords = $('#search').val();
                var oldwords = $('#oldwords').val();
                if(keywords == ''){
                    return false;
                }
                if(keywords == oldwords){
                    return false;
                }
                $('#oldwords').attr('value',keywords);
