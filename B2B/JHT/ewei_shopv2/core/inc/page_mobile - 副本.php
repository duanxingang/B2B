...
class MobilePage extends Page 
{
	...
	public function is_company_reg()
    {
        try {
            global $_W;
            $members = pdo_fetch('select company,business_card,business_img from ' . tablename('ewei_shop_member') . ' where openid=:openid and uniacid=:uniacid and id=:id limit 1', array(':uniacid' => $_W['uniacid'], ':openid' => $_W["mopenid"], ':id' => $_W["mid"]));
