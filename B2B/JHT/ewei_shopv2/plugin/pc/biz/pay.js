define(['core', 'tpl'], function(core, tpl) {
    ...
    modal.pay = function(btn) {
        ...
        if(type == 'wechat2'){
            ...
            location.href = core.getUrl('pc/order/pay/opay', {
                id: modal.params.orderid,
                type: type
            });
        }else if(type == 'banks2') {
    ...
    //微信二维码支付
    modal.payWechat2 = function(btn){
        core.json('pc.order/pay/native_url', {
            id: modal.params.orderid
        }, function(pay_json) {
            if(pay_json.code==1){
                var img = "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=" + pay_json.wechat.code_url;
                ...
                FoxUI.toast.show(pay_json.message)
            }
